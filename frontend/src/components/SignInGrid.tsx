...
const SignInGrid = () => {
  ...
  return (
    <div className="w-full flex justify-center">
      <div
        className=" w-4/5 flex justify-between mt-6"
        style={{ height: "250px" }}
      >
        <div
          id="signInDivGoogle"
        ...
        <div
          id="signInDivLinkedIn"
          className="bg-blue flex justify-evenly flex-col"
        >
          {linkedInUser && (
            <div>
        ...
        <div
          id="signInDivFacebook"
          className="bg-pink flex justify-evenly flex-col"
        >
          {facebookUser && (
            <div>
